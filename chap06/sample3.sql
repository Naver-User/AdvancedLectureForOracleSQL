...
-- 직무가 IT_PROG인 사원의 월급보다 *작은* 사원 정보 조회
SELECT
    last_name,
    department_id,
    salary
...
-- 직무가 IT_PROG인 사원의 월급보다 *많은* 사원 정보 조회
SELECT
    last_name,
    department_id,
    salary
...
-- 직무가 IT_PROG인 사원의 *최소급여보다 큰* 급여를 받는 전체사원조회
SELECT
    last_name,
    department_id,
    salary
...
-- 직무가 IT_PROG인 사원의 *최대급여보다 작은* 급여를 받는 모든 사원조회
SELECT
    last_name,
    department_id,
    salary
