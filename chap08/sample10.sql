...
--       자식 테이블 삭제 후, 다시 Flashback Drop 기능으로 되살렸을 때에,
--       복구된 자식테이블의 제약조건도 그대로 다시 복구되는가?
DROP TABLE emp02;       -- (1) 자식테이블 삭제

FLASHBACK TABLE emp02 TO BEFORE DROP;   -- (2) 휴지통에서 삭제된 자식테이블 복구
