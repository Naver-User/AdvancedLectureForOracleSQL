...
--  [ START WITH n ]
--      순차번호의 시작값 지정. 생략시 1부터 시작 (default)
--  [ INCREMENT BY n ]
--      연속적인 순차번호의 증가치 지정. 
--      음수도 가능 (감소치), 생략시 1씩 증가 (default)
...
--  라. (*주의할 점*) 
--      (1) 반드시 NEXTVAL 먼저 호출, 나중에 CURRVAL 호출해야 함
--      (2) SELECT문장의 SELECT 절에서 호출해야 함
-- ------------------------------------------------------
